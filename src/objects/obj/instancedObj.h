...
#ifndef INSTANCEDOBJ_H
#define INSTANCEDOBJ_H
...
struct instancedObj {
    ...
    // Base use fonctions
    virtual void initialize(GLuint programID,GLuint depthProgramID, int blockBindID, GLuint amount,
        const char *filename, const char *texturePath = NULL,
